...
plt.subplot(221)
plt.plot(t1, ct1, 'r--', linewidth=1, label=fr'$L = 50 \mid T = 1$')
plt.plot(t2, ct2, 'g--', linewidth=1, label=fr'$L = 50 \mid T = 2.27$')
plt.plot(t3, ct3, 'b--', linewidth=1, label=fr'$L = 50 \mid T = 3$')
plt.xlabel('t(MCS)')
plt.ylabel('C(t)')
plt.title(r'$L = 50$')
plt.grid()
...
plt.subplot(222)
plt.plot(t4, ct4, 'r', linewidth=1, label=fr'$L = 100 \mid T = 1$')
plt.plot(t5, ct5, 'g', linewidth=1, label=fr'$L = 100 \mid T = 2.27$')
plt.plot(t6, ct6, 'b', linewidth=1, label=fr'$L = 100 \mid T = 3$')
plt.xlabel('t(MCS)')
plt.ylabel('C(t)')
plt.title(r'$L = 100$')
plt.grid()
...
plt.subplot(223)
plt.plot(r1, cr1, 'r--', linewidth=1, label=fr'$L = 50 \mid T = 1$')
plt.plot(r2, cr2, 'g--', linewidth=1, label=fr'$L = 50 \mid T = 2.27$')
plt.plot(r3, cr3, 'b--', linewidth=1, label=fr'$L = 50 \mid T = 3$')
plt.xlabel('r')
plt.ylabel('C(r)')
plt.grid()
...
plt.subplot(224)
plt.plot(r4, cr4, 'r', linewidth=1, label=fr'$L = 100 \mid T = 1$')
plt.plot(r5, cr5, 'g', linewidth=1, label=fr'$L = 100 \mid T = 2.27$')
plt.plot(r6, cr6, 'b', linewidth=1, label=fr'$L = 100 \mid T = 3$')
plt.xlabel('r')
plt.ylabel('C(r)')
plt.grid()
plt.legend()
